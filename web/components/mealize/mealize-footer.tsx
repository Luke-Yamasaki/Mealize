...
/** Ported from `react-app/src/Components/Footer/index.js` (stack list already reflects the Next app). */
export function MealizeFooter() {
  return (
    <div
      className="flex w-screen max-w-[1336px] flex-col items-start justify-start bg-[#76D97E]"
      style={{
        height: "400px",
    ...
    >
      <div
        className="flex w-[calc(100vw-10px)] max-w-[1326px] flex-row items-start justify-start gap-2.5 pl-2.5"
        style={{ height: "300px" }}
      >
        <ul className="text-[21px] font-black">
          <p className="text-[21px] font-black underline">Technology</p>
          <li className="list-none text-[14px] font-bold no-underline">
            <p>Next.js / React</p>
          </li>
          <li className="list-none text-[14px] font-bold no-underline">
            <p>tRPC</p>
        ...
        <ul className="mb-2.5 text-[21px] font-black underline">
          <p className="text-[21px] font-black underline">Mealize</p>
          <li className="list-none text-[14px] font-bold">
            <a
              className="cursor-pointer text-black"
              href="https://github.com/Luke-Yamasaki/Mealize/wiki"
              target="_blank"
      ...
      <section className="flex h-[100px] w-screen max-w-[1336px] flex-row justify-start">
        <div className="flex h-10 w-[750px] flex-row items-center justify-start gap-2.5 pl-[50px]">
          <p className="text-[14px] font-black">
            Mealize was designed and developed by Luke Yamasaki
          </p>
          <li className="list-none text-[14px] font-bold no-underline">
            <a
              className="cursor-pointer text-black"
          ...
          <li className="list-none text-[14px] font-bold no-underline">
            ...
            >
              <svg
                ...
                width="20.605"
                height="20.605"
                viewBox="0 0 20.605 20.605"
              >
                <path
                  fill="currentColor"
                  d="M19.133,2.25H1.467A1.478,1.478,0,0,0,0,3.736V21.37a1.478,1.478,0,0,0,1.467,1.486H19.133a1.482,1.482,0,0,0,1.472-1.486V3.736A1.482,1.482,0,0,0,19.133,2.25ZM6.228,19.912H3.174V10.078H6.232v9.833ZM4.7,8.735A1.771,1.771,0,1,1,6.471,6.964,1.772,1.772,0,0,1,4.7,8.735ZM17.675,19.912H14.621V15.128c0-1.141-.023-2.608-1.587-2.608-1.591,0-1.835,1.242-1.835,2.525v4.866H8.145V10.078h2.93v1.343h.041A3.217,3.217,0,0,1,14.01,9.834c3.091,0,3.666,2.038,3.666,4.687Z"
        ...
        <div className="flex h-10 w-[800px] flex-row items-center justify-start gap-2.5">
          <p className="text-[14px] font-black">
            Huge thanks to App Academy and the Rocky Mountain College of Art + Design
          </p>
          <li className="list-none text-[14px] font-bold no-underline">
            <a
              className="cursor-pointer text-black"
              ...
              target="_blank"
              rel="noreferrer noopener"
              aria-label="App Academy"
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img
                className="size-[30px] rounded-full grayscale"
                src="https://pbs.twimg.com/profile_images/378800000699275845/28983bbc0ac0a12cde1c0dc3fc818b4b.png"
                alt="App Academy"
              />
            </a>
          </li>
          <li className="list-none text-[14px] font-bold no-underline">
            ...
            >
              ...
              <img
                className="size-[30px] rounded-full grayscale"
                src="https://pbs.twimg.com/profile_images/928309188970782720/lnLDcr-J_400x400.jpg"
                alt="Rocky Mountain College of Art and Design"
              />
            </a>
          </li>
        </div>
