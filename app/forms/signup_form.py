...
from app.utils.stdnum.us.ein import *
...
class SignupForm(FlaskForm):
    ...
    jobDescription = StringField('Job description', valdiators=[InputRequired(), Length(max=255, message='Sorry, job descriptions must be less than 255 characters.')])
