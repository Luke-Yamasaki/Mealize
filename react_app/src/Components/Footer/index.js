            ...
            <section style={{width: '1600px', height: '100px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}>
                <div style={{width: '750px', height: '40px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', gap: '10px', alignItems: 'center', paddingLeft: '50px'}}>
                    ...
                    <li style={{listStyle: 'none', fontSize: '14px', fontWeight: '700', textDecoration: 'none'}}>
                        <div>
                            <a style={{color: 'black', cursor: 'pointer'}} href='https://github.com/Luke-Yamasaki' target='_blank'>
                    ...
                    <li style={{listStyle: 'none', fontSize: '14px', fontWeight: '700', textDecoration: 'none'}}>
                        <div>
                            <a style={{color: 'black', cursor: 'pointer'}} href='https://www.linkedin.com/in/lukeyamasaki/' target='_blank'>
                    ...
                    <li style={{listStyle: 'none', fontSize: '14px', fontWeight: '700', textDecoration: 'none'}}>
                        <div>
                            <a style={{color: 'black', cursor: 'pointer'}} href='https://www.behance.net/lukeyamasac140' target='_blank'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20.605" height="20.605" viewBox="0 0 20.605 20.605">
                ...
                <div style={{width: '800px', height: '40px', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', gap: '10px'}}>
                    ...
                    <li style={{listStyle: 'none', fontSize: '14px', fontWeight: '700', textDecoration: 'none'}}>
                        <div>
                            <a style={{color: 'black', cursor: 'pointer'}} href='https://www.appacademy.io/' target='_blank'>
                    ...
                    <li style={{listStyle: 'none', fontSize: '14px', fontWeight: '700', textDecoration: 'none'}}>
                        <div>
                            <a style={{color: 'black', cursor: 'pointer'}} href='https://www.rmcad.edu/' target='_blank'>
